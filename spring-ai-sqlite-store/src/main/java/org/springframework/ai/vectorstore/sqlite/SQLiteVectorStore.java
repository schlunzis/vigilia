...
package org.springframework.ai.vectorstore.sqlite;
 ...
 * @since 1.0.0
 */
public class SQLiteVectorStore extends AbstractObservationVectorStore implements InitializingBean {
    ...
    private static Map<SQLiteDistanceType, VectorStoreSimilarityMetric> SIMILARITY_TYPE_MAPPING = Map.of(
            SQLiteDistanceType.COSINE_DISTANCE, VectorStoreSimilarityMetric.COSINE);
    ...
    private final SQLiteDistanceType distanceType;
    ...
    private final SQLiteIndexType createIndexMethod;
    ...
    /**
     * @param builder {@link Builder} for sqlite vector store
     */
    ...
    public SQLiteDistanceType getDistanceType() {
...
//        this.jdbcTemplate.execute(String.format("CREATE SCHEMA IF NOT EXISTS %s", this.getSchemaName()));
    ...
    /**
     * The ID type for the sqlite vector store schema. Defaults to UUID.
     */
    public enum SQLiteIdType {
     ...
     */
    public enum SQLiteDistanceType {
        ...
        SQLiteDistanceType(String operator, String index, String sqlTemplate) {
    ...
    private static class DocumentRowMapper implements RowMapper<Document> {
        ...
        private Map<String, Object> toMap(String pgObject) {
            try {
                return (Map<String, Object>) this.objectMapper.readValue(pgObject, Map.class);
            } catch (JsonProcessingException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public static final class SQLiteVectorStoreBuilder extends AbstractVectorStoreBuilder<SQLiteVectorStoreBuilder> {
        ...
        private boolean vectorTableValidationsEnabled = SQLiteVectorStore.DEFAULT_SCHEMA_VALIDATION;

        private int dimensions = SQLiteVectorStore.INVALID_EMBEDDING_DIMENSION;

        private SQLiteDistanceType distanceType = SQLiteDistanceType.COSINE_DISTANCE;

        private boolean removeExistingVectorStoreTable = false;

        private SQLiteIndexType indexType = SQLiteIndexType.HNSW;
        ...
        public SQLiteVectorStoreBuilder idType(SQLiteIdType idType) {
            this.idType = idType;
            return this;
        }

        public SQLiteVectorStoreBuilder vectorTableValidationsEnabled(boolean vectorTableValidationsEnabled) {
        ...
        public SQLiteVectorStoreBuilder distanceType(SQLiteDistanceType distanceType) {
            this.distanceType = distanceType;
            return this;
        }

        public SQLiteVectorStoreBuilder removeExistingVectorStoreTable(boolean removeExistingVectorStoreTable) {
            this.removeExistingVectorStoreTable = removeExistingVectorStoreTable;
            return this;
        }

        public SQLiteVectorStoreBuilder indexType(SQLiteIndexType indexType) {
        ...
        public SQLiteVectorStoreBuilder maxDocumentBatchSize(int maxDocumentBatchSize) {
